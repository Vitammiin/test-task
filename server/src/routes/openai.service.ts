...
import { processAudioForOpenAI } from '../utils/audio';
...
export class OpenAIService {
    ...
    private readonly SESSION_DURATION = 14 * 60 * 1000;
    ...
    initializeWebSocket(clientWs: WebSocket) {
        ...
        this.ws = new WebSocket(url, {
            headers: {
                ...
                "organization": "org-G9UYXzDRlSaUQvstC9kisNxv",
                "project": "proj_2FOmkF2YfZJDcnvZJJ9sYBa4"
            }
        });
